...
body, div, ol, li, from, filedset, legend, input,table,table th ,table thead, table tbody{font-family: 'CookieRun-Regular'}
...
<body style="width: 700px;"  class="body">
<form action="list.bo" method="post" style="width: 700px;">
<fieldset>
...
<% 
	...
	<tr><td>
		...
		<td><%= arraylist.get(i).getLeave_Work() %> </td>
