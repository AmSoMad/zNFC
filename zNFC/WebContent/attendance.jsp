...
<form action="A_attendance.bo" method="get">
<fieldset>
<legend>출근등록 <span id="nowTimes"></span></legend>
NFC 아이디 : <input type="text" name="nfcid"><br>
<input type="hidden" value="<%=currentDatetime %>" name="time">
<input type="submit" value="출근"><a href="index.jsp"><input type="button" value="메인"></a>
</fieldset>
</form>
</body>
</html>